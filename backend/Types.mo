...
module {
  ...
  public module Topic {
      ...
      public func idHash(i : Id) : Hash.Hash { switch (i) { case (#topic n) hash n } };
  ...
  public module User {
      ...
      public func idHash(i : Id) : Hash.Hash { switch (i) { case (#user n) hash n } };
      public func idEqual(i : Id, j : Id) : Bool { i == j };
      public type RawId = Nat;
  ...
  public module Team {
      ...
      public func idHash(i : Id) : Hash.Hash { switch (i) { case (#team n) hash n } };
      public func idEqual(i : Id, j : Id) : Bool { i == j };
      public type RawId = Nat;
